namespace YourShipping.Monitor.Server.Services.HostedServices
{
    ...
    {
        public StoreMonitorHostedService(IServiceProvider serviceProvider, IConfiguration configuration)
            : base(
                serviceProvider,
                ...
                async storedStore =>
                    {
                        ...
                        var storeScrapper = serviceProvider.GetService<IEntityScraper<Store>>();
                        ...
                        if (transaction != null)
                        {
                            ...
                            if (telegramBotClient != null && store.IsAvailable)
                            {
                                ...
                                messageStringBuilder.AppendLine(
                                    $"*Has Products In Cart:* _{storeDataTransferObject.HasProductsInCart}_");
                                messageStringBuilder.AppendLine(
